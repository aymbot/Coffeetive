...
class StatisticsFragment : Fragment(), OnChartValueSelectedListener {
    ...
    private fun setData(count: Int, range: Float) {
        ...
        moodarray.forEach(){
            values.add(Entry(2f, it.mood.toFloat()))
        }
        coffeearray.forEach(){
            values2.add(Entry(1f, it.coffeesize.toFloat()))
        }
        ...
        if (chart.data != null && chart.data.dataSetCount > 0) {
            ...
            set2 = LineDataSet(values, "Coffee / Cups")
            ...
            set2.fillFormatter = IFillFormatter { dataSet, dataProvider -> chart.axisLeft.axisMinimum }
